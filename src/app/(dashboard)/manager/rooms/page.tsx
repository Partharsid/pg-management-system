      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {rooms.map((room) => {
          ...
          return (
            <Card
              key={room.id}
              className={cn("hover:shadow-md transition-shadow cursor-pointer", isFullyOccupied && "border-green-200")}
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Floor {room.floor} • {room.roomType}</p>
                  </div>
                ...
                <div className="flex items-center justify-between text-sm">
                  <span className="text-gray-500">₹{Number(room.baseRent).toLocaleString()}/month</span>
                  <span className="text-gray-500">{occupiedCount}/{room.beds.length} occupied</span>
                </div>
              </CardContent>
            </Card>
          );
